            ...
            g > 0
                ...
                : g < 0 &&
                  (b &&
                      ...
                      i.currentTranslate < (r.centeredSlides ? s.maxTranslate() + s.slidesSizesGrid[s.slidesSizesGrid.length - 1] + s.params.spaceBetween + ("auto" !== r.slidesPerView && s.slides.length - r.slidesPerView >= 2 ? s.slidesSizesGrid[s.slidesSizesGrid.length - 1] + s.params.spaceBetween : 0) : s.maxTranslate()) &&
            ...
            function z(e) {
                ...
                i >= 0 && g.splice(i, 1),
                    m &&
                        ...
                        ((m = !1),
                        (h = !1),
                        v.imageEl && ((a.scale = Math.max(Math.min(a.scale, v.maxRatio), s.minRatio)), (v.imageEl.style.transitionDuration = `${t.params.speed}ms`), (v.imageEl.style.transform = `translate3d(0,0,0) scale(${a.scale})`), (l = a.scale), (o = !1), a.scale > 1 && v.slideEl ? v.slideEl.classList.add(`${s.zoomedSlideClass}`) : a.scale <= 1 && v.slideEl && v.slideEl.classList.remove(`${s.zoomedSlideClass}`), 1 === a.scale && ((v.originX = 0), (v.originY = 0), (v.slideEl = void 0))));
            }
            function A() {
